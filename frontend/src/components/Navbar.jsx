      ...
      <div className="mx-auto flex max-w-[1440px] items-center gap-4 px-4 py-3 sm:px-6">
        <div className="flex min-w-0 flex-1 items-center justify-between gap-4">
          <NavLink to="/dashboard" className="flex flex-shrink-0 items-center gap-2 transition-opacity hover:opacity-80">
            ...
            <span className="text-lg font-black tracking-tight text-indigo-700 sm:text-xl">MasteryAI</span>
          </NavLink>

          <div className="relative hidden w-72 max-w-full flex-shrink-0 lg:block">
